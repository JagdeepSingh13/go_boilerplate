...
import (
	...
	"github.com/JagdeepSingh13/go_boilerplate/internal/database"
	"github.com/JagdeepSingh13/go_boilerplate/internal/handler"
	"github.com/JagdeepSingh13/go_boilerplate/internal/logger"
	"github.com/JagdeepSingh13/go_boilerplate/internal/repository"
	"github.com/JagdeepSingh13/go_boilerplate/internal/router"
...
func main() {
	...
	if err != nil {
		panic("failed to load confug: " + err.Error())
	}
